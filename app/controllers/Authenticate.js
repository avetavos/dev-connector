...
const Register_1 = tslib_1.__importDefault(
  require('../middlewares/validations/Register')
);
const Login_1 = tslib_1.__importDefault(
  require('../middlewares/validations/Login')
);
