...
const authentication_1 = tslib_1.__importDefault(
  require('../middlewares/authentication')
);
const Profile_1 = tslib_1.__importDefault(require('../models/Profile'));
const User_1 = tslib_1.__importDefault(require('../models/User'));
const Profile_2 = tslib_1.__importDefault(
  require('../middlewares/validations/Profile')
);
const Experience_1 = tslib_1.__importDefault(
  require('../middlewares/validations/Experience')
);
const Education_1 = tslib_1.__importDefault(
  require('../middlewares/validations/Education')
);
